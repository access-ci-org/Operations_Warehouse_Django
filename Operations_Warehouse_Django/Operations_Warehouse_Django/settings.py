...
Upgraded to Django 5.0 in December 2024
...
if CONF.get('OPENSEARCH_HOSTS'):
    ...
    for url in CONF.get('OPENSEARCH_HOSTS'):
        ...
        hosts.append(
            {'scheme': urlparse.scheme, 'host': urlparse.hostname, 'port': port}
        )
...
if SETTINGS_MODE == 'SERVER':
    ...
    TOKENAUTH_INTROSPECTION_CACHE_EXPIRATION = CONF.get(
        'TOKENAUTH_INTROSPECTION_CACHE_EXPIRATION', None
    )
    # to let us disable authentication for api routes for debugging
    DISABLE_PERMISSIONS_FOR_DEBUGGING = CONF.get(
...
GLOBUS_CLIENT_ID = CONF.get('SOCIAL_AUTH_GLOBUS_KEY', None)
GLOBUS_CLIENT_SECRET = CONF.get('SOCIAL_AUTH_GLOBUS_SECRET', None)
GLOBUS_SEARCH_INDEX_ID = CONF.get(
    'GLOBUS_SEARCH_INDEX_ID', "3cc4aeec-55a5-4cd6-96d1-8531aef88e83")
