...
urlpatterns = [
    ...
    path('v1/info_groupid/<str:info_groupid>/current_outages/', News_v2_Current_Outages.as_view(), name='news-v1-current-bygroup-outages'),
    path('v1/info_groupid/<str:info_groupid>/future_outages/', News_v2_Future_Outages.as_view(), name='news-v1-future-bygroup-outages'),
]
