...
urlpatterns = [
     path(r'v1/roadmaps/', Integration_Roadmap_v1.as_view(), name='integration-roadmap-v1-all'),
     path(r'v1/roadmap/<str:integration_roadmap_id>/', Integration_Roadmap_v1.as_view(), name='integration-roadmap-v1-id'),
     path(r'v1/badges/', Integration_Badge_v1.as_view(), name='integration-badges-v1-all'),
     path(r'v1/badge/<str:integration_badge_id>/', Integration_Badge_v1.as_view(), name='integration-badges-v1-id'),
     path(r'v1/badge/<str:integration_badge_id>/tasks/', Integration_Task_v1.as_view(), name='integration-tasks-v1-id'),
