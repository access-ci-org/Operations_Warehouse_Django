...
class CiderInfrastructure_Summary_Serializer(serializers.ModelSerializer):
    ...
    def get_cider_view_url(self, CiderInfrastructure):
        try:
            ...
            return None
    def get_cider_data_url(self, object):
...
class CiderInfrastructure_Compute_Serializer(serializers.ModelSerializer):
    ...
    def get_cpu_speed_ghz(self, object):
        try:
    ...
    def get_memory_per_cpu_gb(self, object):
        try:
            return object.other_attributes['memory_per_cpu_gb']
        except:
            return None
            
    def get_cpu_count_per_node(self, object):
        try:
            return object.other_attributes['cpu_count_per_node']
        except:
            return None
            
    def get_xsedenet_participation(self, object):
        try:
            return object.other_attributes['xsedenet_participation']
        except:
            return None
            
    def get_supports_senstitive_data(self, object):
        try:
